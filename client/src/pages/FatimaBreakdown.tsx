/*
Business breakdown page for Fatima. After the hero, prospects see
...
const HERO_EMBED_ID = "oyLIehxUUMWpHHVm";
...
export default function FatimaBreakdown() {
  useEffect(() => {
    document.title = "Fatima Breakdown | KST Marketing";
  }, []);
