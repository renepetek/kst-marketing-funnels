/*
Business breakdown page for Harjinder. After the hero, prospects see
...
const HERO_EMBED_ID = "W3XYYqRryJm59S6H";
...
export default function HarjinderBreakdown() {
  useEffect(() => {
    document.title = "Harjinder Breakdown | KST Marketing";
  }, []);
