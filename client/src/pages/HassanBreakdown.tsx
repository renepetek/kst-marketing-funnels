/*
Business breakdown page for Hassan. After the hero, prospects see
...
const HERO_EMBED_ID = "QBlHdGtFnFkpQRAP";
...
export default function HassanBreakdown() {
  useEffect(() => {
    document.title = "Hassan Breakdown | KST Marketing";
  }, []);
